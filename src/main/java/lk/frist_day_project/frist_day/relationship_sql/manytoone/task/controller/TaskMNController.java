package lk.frist_day_project.frist_day.relationship_sql.manytoone.task.controller;
...
public class TaskMNController {
    ...
    public String findAll(Model mode) {
        ...
        return "relationship_sql/manytoone/task/task_one_one";
    }
    ...
    public String form(Model model) {
        ...
        model.addAttribute("task", new TaskMN());
        return "relationship_sql/manytoone/task/task_one_one_add";
    }

    //to persist task details 
    @PostMapping
    public String persist(@ModelAttribute TaskMN task) {
