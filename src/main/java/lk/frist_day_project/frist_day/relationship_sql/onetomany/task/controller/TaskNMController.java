package lk.frist_day_project.frist_day.relationship_sql.onetomany.task.controller;
...
public class TaskNMController {
    ...
    public String findAll(Model mode) {
        ...
        return "relationship_sql/onetomany/task/task_one_one";
    }
    ...
    public String form(Model model) {
        ...
        model.addAttribute("task", new TaskNM());
        return "relationship_sql/onetomany/task/task_one_one_add";
    }

    //to persist task details 
    @PostMapping
    public String persist(@ModelAttribute TaskNM task) {
